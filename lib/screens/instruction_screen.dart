          ...
          Container(
            ...
            child: const Center(
              child: Column(
                ...
                children: [
                  Icon(Icons.play_circle_outline, color: Colors.white24, size: 60),
                  SizedBox(height: 10),
                  Text("Здесь будет видео-инструкция", style: TextStyle(color: Colors.white24)),
                ],
              ),
            ),
          ),
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (context) => WorkoutScreen(difficulty: difficulty),
                          ),
                        );
                      },
                      child: const Text(
